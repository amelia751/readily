...
//     setEditIndex(index);
//     setEditArea(keyAreas[index]);
//   };

//   const handleSave = () => {
//     setKeyAreas(prevKeyAreas => prevKeyAreas.map((area, i) => (i === editIndex ? editArea : area)));
//     setEditIndex(null);
...
//         className="mb-4"
//       />
//       <Button onClick={handleGenerate}>Generate Key Areas</Button>
//       {error && <p className="text-red-600 mt-4">{error}</p>}
//       {keyAreas && (
//         <div className="mt-4">
//           {keyAreas.map((keyArea, index) => (
//             <div key={keyArea.keyAreaID} className="bg-gray-100 p-4 rounded-lg shadow-md mb-4 relative">
...
//   return (
//     <div className="p-4 flex flex-col md:flex-row md:space-x-5">
