...
const moduleSchema = new Schema({
  ...
  moduleProgress: { type: String, required: false }
});
...
const therapySchema = new Schema({
  mapID: { type: String, unique: false },
...
const Therapy = mongoose.models.Therapy || mongoose.model('Therapy', therapySchema, 'therapies');
